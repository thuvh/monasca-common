...
health_check.py
  ...
  container. It will be useful for container orchestration like Kubernetes or
  Docker Swarm to properly handle services that are still running but stopped
  being responsive. Avoid using `curl` directly and instead use
...
Please, check content of every of these files for documentation of what
