...
public class AlarmUpdatedEvent implements Serializable {
  ...
  public AlarmUpdatedEvent(String tenantId, String alarmId, AlarmState alarmState,
  ...
  public String toString() {
    return "AlarmUpdatedEvent [tenantId=" + tenantId + ", alarmId=" + alarmId + ", alarmState="
        + alarmState + ", oldAlarmState=" + oldAlarmState + "]";
  }
}
