...
public class AlarmUpdatedEvent implements Serializable {
  ...
  public AlarmUpdatedEvent(String tenantId, String alarmId, String alarmDefinitionId,
  ...
  public String toString() {
    return "AlarmUpdatedEvent [tenantId=" + tenantId + ", alarmId=" + alarmId
        + ", alarmDefinitionId=" + alarmDefinitionId + ", alarmState=" + alarmState
        + ", oldAlarmState=" + oldAlarmState + "]";
  }
}
