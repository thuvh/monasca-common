...
public class Log implements Serializable {
  ...
  public Log(@Nullable String applicationType, @Nullable Map<String, String> dimensions, String message) {
  ...
  public String toString() {
    return "Log{" + "applicationType='" + applicationType + '\'' + ", dimensions=" + dimensions + ", message=" + message + '}';
  }
