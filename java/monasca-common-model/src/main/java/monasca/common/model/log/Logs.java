...
public final class Logs {
  ...
  /** Log serializer */
  private static class LogSerializer extends JsonSerializer<Log> {
    @Override
    public Class<Log> handledType() {
      return Log.class;
    }

    public void serialize(Log log, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
