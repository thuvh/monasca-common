...
public class MetricPeriod {
   ...
   * period value answers is metric is periodic or sparse
   */
  private static final long THRESHOLD = 0L;

  private MetricPeriod(){}

  public static boolean isSparse(final Metric metric){
    return metric != null && isSparse(metric.getPeriod());
  }

  public static boolean isSparse(final long period){
