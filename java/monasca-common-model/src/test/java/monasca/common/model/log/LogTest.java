 ...
 * the License.
 */
package monasca.common.model.log;
...
public class LogTest {
  public void shouldSerializeValue() {
    ...
    assertEquals(json, "{\"application_type\":\"apache\",\"dimensions\":{\"app_name\":\"WebService01\",\"environment\":\"production\"},"
        + "\"message\":\"Hello, world!\"}");
  }
  ...
  public void shouldSerializeValueWithNull() {
    ...
    Log log = new Log(applicationType, dimensions, message);
    String json = Logs.toJson(log);
    assertEquals(json, "{\"dimensions\":{\"app_name\":\"WebService01\",\"environment\":\"production\"}," + "\"message\":\"Hello, world!\"}");
  }
  ...
  public void shouldSerializeValueWithNull_2() {
    ...
    Log log = new Log(applicationType, dimensions, message);
    String json = Logs.toJson(log);
    assertEquals(json, "{\"application_type\":\"apache\"," + "\"message\":\"Hello, world!\"}");
  }
  ...
  public void shouldSerializeValueWithEmpty_3() {
    ...
    Log log = new Log(applicationType, dimensions, message);
    String json = Logs.toJson(log);
    assertEquals(json, "{\"dimensions\":{\"app_name\":\"WebService01\",\"environment\":\"production\"}," + "\"message\":\"\"}");
  }
  ...
  public void shouldSerializeValueUTF() {
    ...
    Log log = new Log(applicationType, dimensions, message);
    String json = Logs.toJson(log);
    assertEquals(json, "{\"application_type\":\"foôbár\",\"dimensions\":{\"app_name\":\"foôbár\",\"instance_id\":\"123\"},"
        + "\"message\":\"boôbár\"}");
  }
