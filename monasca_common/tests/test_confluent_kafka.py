...
class TestConfluentKafkaProducer(base.BaseTestCase):
    ...
    def test_kafka_producer_publish(self):
        ...
        self.prod._producer.produce.assert_called_once_with(topic, expected_message, None,
                                                            callback=
                                                            producer.KafkaProducer.delivery_report)
    ...
    def test_kafka_producer_publish_one_message_with_key(self):
        ...
        self.prod._producer.produce.assert_called_once_with(topic, expected_message, key,
                                                            callback=
                                                            producer.KafkaProducer.delivery_report)
        self.prod._producer.flush.assert_called_once()
