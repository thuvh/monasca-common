...
from monasca_common.kafka.consumer import KAFKA_CONSUMER_ITER_TIMEOUT
from monasca_common.kafka.consumer import KafkaConsumer
from monasca_common.kafka.producer import KAFKA_PRODUCER_ACK_TIMEOUT
...
class TestKafkaConsumer(unittest.TestCase):
    ...
    def test_kafka_consumer_init(self):
        ...
        self.mock_kafka_consumer.SimpleConsumer.assert_called_once_with(
            ...
            auto_commit=False,
            partitions=None,
            iter_timeout=KAFKA_CONSUMER_ITER_TIMEOUT,
