...
from monasca_common.kafka import consumer as m_consumer
from monasca_common.kafka import producer as m_producer
...
class TestKafkaProducer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.monasca_kafka_producer = m_producer.KafkaProducer(FAKE_KAFKA_URL)
...
class TestKafkaConsumer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.monasca_kafka_consumer = m_consumer.KafkaConsumer(
