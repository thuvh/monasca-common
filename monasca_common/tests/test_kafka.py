...
from monasca_common.kafka.consumer import DEFAULT_KAFKA_CONSUMER_ITER_TIMEOUT
...
from monasca_common.kafka.producer import DEFAULT_KAFKA_PRODUCER_ACK_TIMEOUT
from monasca_common.kafka.producer import KafkaProducer
from monasca_common.kafka.producer import SECOND
...
class TestKafkaProducer(unittest.TestCase):
    ...
    def test_kafka_producer_publish_one_message_without_key(self, mock_time):
        ...
        expected_key = str(mock_time.time.return_value * SECOND)
...
class TestKafkaConsumer(unittest.TestCase):
    ...
    def test_kafka_consumer_process_messages(self, mock_set_partitioner):
        ...
        for _ in self.monasca_kafka_consumer:
            pass
